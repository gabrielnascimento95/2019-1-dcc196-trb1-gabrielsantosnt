...
<body>
    <div class="container">
        ...
        <br />
        <h4 style="text-align: center">Relatório geral</h4>
        <div class="row">
            <div class="col-sm-6">
                <ul class="list-group" id="sede" name="sede">
                    <c:forEach var="sede" items="${sedes}">
                        <li class="list-group-item" value="${sede.id}"> ${sede.nome}</li>
                    </c:forEach>
                </ul>
            </div>
            <div class="col-sm-1">
            ...
            <div class="col-sm-5">
                <ul class="list-group" id="tempoTotal" name="tempoTotal">
                    <c:forEach var="tempo" items="${tempoTotal}">
                        <li class="list-group-item" value="${tempo}"> ${tempo} minuto(s)</li>
                    </c:forEach>
                </ul>
            </div>
        </div>
